    ...
    // primaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://hydrogenv1.netlify.app/assets/images/hero.webp',
          },
    ...
    // tertiaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0637/6947/7347/collections/PR12261_blush_champagne_f_d.jpg?v=1657656922',
          },
